...
KEY_D_ORDER_STATUS_CANCELLED = "KEY_D_ORDER_STATUS_CANCELLED"
...
valueset = {
    ...
    KEY_D_ORDER_STATUS_CANCELLED: {KEY_LANGUAGE_EN:  "Order Cancelled", KEY_LANGUAGE_TA: "ஆர்டர் நிராகரிக்கப்பட்டது"},
